...
@section('c-buttons')
    ...
    @if(isset($edit))
        <a href="{{ route('system.settings.faq.delete', ['id' => $faq->id ]) }}">
...
@section('content')
    <div class="content-wrapper content-wrapper-p-15">
        ...
        <div class="row">
            <div class="col-md-12">
                <form action="@if(isset($edit)) {{ route('system.settings.faq.update') }} @else {{ route('system.settings.faq.save') }} @endif" method="POST" id="js-form">
                    @if(isset($edit))
