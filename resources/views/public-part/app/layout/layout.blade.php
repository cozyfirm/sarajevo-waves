<html>
    <head>
        <title> @yield('title', 'Cozy Firm d.o.o') </title>
        ...
        <!-- Meta tags -->
        @include('public-part.app.layout.snippets.meta-tags')

        @vite(['resources/css/public-part/public.scss', 'resources/js/app.js'])
        @yield('js-scripts')
    </head>

    <body>
        <!-- Static element on every page -->
        @include('public-part.app.layout.snippets.menu')
        ...
        <!-- Static element on every page -->
        @include('public-part.app.layout.snippets.footer')
    </body>
</html>
