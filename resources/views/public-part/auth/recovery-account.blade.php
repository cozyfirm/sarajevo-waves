        ...
        <div class="aw-form-wrapper">
            <div class="aw-form">
                ...
                <div class="aw-form-header">
                    <h1>{{ __('Oporavak korisničkog računa') }}</h1>
                    <p>{{ __('Unesite email adresu koju ste koristili prilikom registracije. Upute za oporavak računa bit će poslane na navedenu email adresu.') }}</p>
                </div>
                <div class="aw-form-form">
                    <div class="aw-ff-input-wrapper email-wrapper">
                        ...
                        <div class="input-wrapper">
                            ...
                            {{ html()->text('recovery-account-email')->class('input recovery-account-email')->required()->placeholder('Unesite vaš email') }}
                        </div>
                    </div>

                    <div class="aw-ff-input-wrapper">
                        <button class="recovery-account-btn">{{ __('Pošalji upute') }}</button>
                    </div>
                </div>
            </div>
        </div>
